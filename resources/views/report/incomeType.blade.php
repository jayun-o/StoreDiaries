...
<div class="container">
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="panel-heading">รายรับ: กราฟวงกลมแสดงสัดส่วนประเภทของรายรับ</div>
                ...
                <!-- --------------------------------------------search----------------------------------------------------------->
                    <div class="form-group">
                        <form action = "incomeTypePieChart" method = "get">
                            @csrf
                ...
                <!-- --------------------------------------------graph----------------------------------------------------------->
                        <script type="text/javascript">
                            var analytics = <?php echo $incomeType; ?>
