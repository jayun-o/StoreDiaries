...
<div class="container">
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="panel-heading">รายจ่าย: กราฟวงกลมแสดงสัดส่วนวิธีการจ่ายเงิน</div>
                ...
                <!-- --------------------------------------------search----------------------------------------------------------->
                    <div class="form-group">
                        <form action = "expensesMethodPieChart" method = "get">
                            @csrf
                ...
                <!-- --------------------------------------------graph----------------------------------------------------------->
                        ...
                        <script type="text/javascript">
                            var analytics = <?php echo $expensesMethod; ?>
                            ...
                            function drawChart()
                            {
                                ...
                                var options = {
                                    title : 'สัดส่วนวิธีการรับเงินของรายรับ'
                                };
